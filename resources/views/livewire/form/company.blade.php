...
{{--</form>--}}
    ...
    <form wire:submit="{{ $action }}">
        <x-input title="Name company" model="title" />
        <x-input title="Company logo" model="logo_url" type="file" required="true"  ignore="{{true}}" />
        <x-input title="Company qrcode" model="qrcode_url" type="file"  ignore="{{true}}" />
            <x-select title="Company leader" model="user_id" :options="$usersOption"/>
